...
int main(){
    ...
    const char *filename = "toy_a1_rig.dat" ;
    ...
    for (int ii = 0; ii < loop; ii++)
    {
        ...
        vector<double>  mu_t_cas(set);
        vector<double>  mu_t_est_cas(set);
        vector<double>  std_t_cas(set);
        vector<double>  std_t_est_cas(set);
        ...
        // ofs<<target<<" "<<sum1_stdt<<" "<<sqrt(var_stdt)<<"\n" ;
