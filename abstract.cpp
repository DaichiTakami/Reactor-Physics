...
int main(){
    ...
    const char *filename = "mix_std.dat" ;
    ...
    int target[28
    ] = {10,15,20,25,30,40,50,60,80,100,150,200,250,300,400,500,600,800,1000,1500,2000,2500,3000,4000,5000,6000,8000,10000} ;
    ...
    for (int ii = 0; ii < loop; ii++)
    {
        ...
        for (int jj = 0; jj < set; jj++)
        {
            ...
            for (int i = 0; i < sample; i++)
            {
                ...
                double kt_i = stHat_1*ds_s_1+stHat_2*ds_s_2+stTilde_1*ds_s_1*ds_s_1+stTilde_2*ds_s_2*ds_s_2 ;
                double km1_i = sm1Hat_1*ds_s_1+sm1Hat_2*ds_s_2 ;
                double km2_i = sm2Hat_1*ds_s_1+sm2Hat_2*ds_s_2 ;
            ...
            for (int i = 0; i < sample; i++)
            {
                ...
                double kt_i = stHat_1*ds_s_1+stHat_2*ds_s_2+stTilde_1*ds_s_1*ds_s_1+stTilde_2*ds_s_2*ds_s_2 ;
                double km_i = (sm1Hat_1*a_0+sm1Hat_2*a_1)*ds_s_1+(sm2Hat_1*a_0+sm2Hat_2*a_1)*ds_s_2 ;
