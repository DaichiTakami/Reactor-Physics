...
int main(){
    ...
    int target[] = {10,15,20,25,30,40,50,60,80,100,150,200,250,300,400,500,600,800,1000,1500,2000,2500,3000,4000,5000,6000,8000,10000} ;
    ...
    for (int ii = 0; ii < loop; ii++)
    {
        ...
        #if deviation
        ofs<<target[ii]<<" "<<sum1_stdtest<<" "<<var_stdtest<<"\n";
        #endif
